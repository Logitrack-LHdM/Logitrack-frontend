...
export function NetworkStatus() {
    ...
    return (
        <div className="bg-destructive text-white w-full px-4 py-2 flex items-center justify-center gap-2 text-sm font-medium sticky top-0 z-[9999] animate-in slide-in-from-top-2 duration-300 shadow-md">
